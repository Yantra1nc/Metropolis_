	...
	* Date: Nov 2022
	* Description: This script will Create B2B Attune VID Record.
	 */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib) {
	        ...
	        function createVIDForJson(JSONfromRnI, fileName, fileId) {
	            try {
	                ...
	                createRnIRecord('Error Occured for For VID ' + JSONfromRnI.VisitInfo.VisitNumber + ' details ' + JSON.stringify(inve), fileName,'','',"Script Error");
	                return '';
	            }
	        }
