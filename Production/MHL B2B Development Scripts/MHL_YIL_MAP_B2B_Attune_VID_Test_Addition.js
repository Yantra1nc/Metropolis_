 ...
 * @NModuleScope SameAccount
	...
	* Date: Nov 2022
	* Description: This script will Add test code on Attune VID record.
 */
						...
						{  ////
										...
										for (var te in testArray) {
											...
											if (testArray[te].ProcessingLocationCode) {
												...
												createRnIRecord("Processing Location Code not found for " + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId);
												//return '-356151';
											}
