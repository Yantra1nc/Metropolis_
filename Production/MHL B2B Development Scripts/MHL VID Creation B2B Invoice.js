	 ...
	 * Date: May 2022
	 * Description: This script will create B2B RNI VID record.
	 */
	                            ...
	                            if (customerDetails) {
	                                ...
	                                if (customerPaymentType != 1) {
	                                    ...
	                                    if (createVID) {
	                                        ...
	                                        createRnIRecord('Could not creates the VID  | ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId, '', "Test Codes not found in JSON ");
