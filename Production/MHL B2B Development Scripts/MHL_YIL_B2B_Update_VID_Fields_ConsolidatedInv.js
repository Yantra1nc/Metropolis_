	 ...
	 * @NModuleScope SameAccount
	 	   * Script Name: MHL_YIL_B2B_Update_VID_Fields_ConsolidatedInv.js
	* Author:Ganesh Sapakale
	* Date: Nov 2022
	* Description: This script will update invoice id on VID record.
	 */
	    ...
	    function (file, format, record, search, runtime, mhllib, datellib) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_mhl_vid_nt_billed_so_2'
	                });
	        ...
	        function map(context) {
				...
				var RecordId = record.submitFields({
						...
						id: i_b2bVId,
						values: {
							custrecord_invoice_number: invoice_id
						},
						options: {
							enableSourcing: true,
