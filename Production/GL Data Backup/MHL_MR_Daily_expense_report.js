 ...
 * Script Name:  MHL_MR_Daily_expense_report.js
 * Author: Avinash Lahane & Ganesh Sapakale
 * Date: May 2022
 * Description: This script will Create GL Data backup Posting period wise.
 */
        ...
        function map(context) {
            try {
				...
				var transactionSearchObj = search.create({
				   type: "transaction",
					title: 'Gl_Extraction_Report_' +subsidiaryTxt+"_"+dateString+"_"+string,
				   filters:
				   [
				...
				{
					var File_Name = 'Gl_Extraction_Report_' + subsidiaryTxt + '_' + dateString +  '.csv';
