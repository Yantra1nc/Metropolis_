 ...
 * Script Name: MHL YIL MR GL Data Backup File Transfer.js
 * Author: Avinash Lahane
 * Date: MAR 2023
 * Description: This script will Transfer GL data backup csv to SFTP Server.
 */
		  ...
		  {				
			...
			if(file_internalId && Folder_name){
				...
				var upload_file = o_connectionOBJ.upload({
					directory: '/DATA BACKUP/'+Folder_name,
