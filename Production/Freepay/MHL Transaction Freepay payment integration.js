 ...
 * Script Name: MHL Transaction Freepay payment integration
 * File Name: MHL Transaction Freepay payment integration.js
 * Created On: 01/02/2023
 * Modified On: 
 * Created By: Sunil Khutwad (Yantra Inc.)
 * Modified By: 
 * Description: Payment creattion.
 *************************************************************/
                                        ...
                                        if (deductionJson[dd].deductionApprovalFlag == 'Y') {
                                            ...
                                            for (var db in dbBrekupDetails) {
                                                ...
                                                if (deductionType == 'TDS') {
                                                    ...
                                                    // Create separate TDS entry
                                                    tdsEntryId = createTDSEntry(customerInternalId, otherDeductionEntry.subsidiary, otherDeductionEntry.location,
                                                        otherDeductionEntry.department, otherDeductionEntry.sbu, arAccount, tdsDebitAcc, deductionTdsAmt, consolidatedInvoiceId);
                            ...
                            log.debug("Deduct Amount Invoice Total-->", otherDeductAmt); */
                              ...
                              log.debug("Deductions ", "deductionRdAmt "+deductionRdAmt+" | deductionRdType "+deductionRdType+" | deductionOcAmt "+deductionOcAmt+" | deductionOcType "+deductionOcType+" | deductionTodAmt "+deductionTodAmt+" | deductionTodType "+deductionTodType+" | deductionIITPAmt "+deductionIITPAmt+" | deductionIITPType "+deductionIITPType);
                                ...
                                if (deductionRdType || deductionOcType || deductionTodType || deductionIITPType) {
                                    ...
                                    otherDeductionEntryId = createOtherDeductionEntry(customerInternalId, otherDeductionEntry, consolidatedInvoiceId, deductionRdAmt, deductionOcAmt, deductionTodAmt, deductionIITPAmt, deductionRdType, deductionOcType, deductionTodType, deductionIITPType, otherDeductionRdIITPDebitAcc, otherDeductionOcDebitAcc, otherDeductionTodDebitAcc);
                                }
 ...
 */
        ...
        function createTDSEntry(entity, subsidiary, location, department, sbu, arAccount, tdsAccount, tdsAmt, consolidatedInvoiceId) {
            if (tdsAmt > 0) {
        ...
        function createOtherDeductionEntry(entity, otherDeductionEntry, consolidatedInvoiceId, deductionRdAmt, deductionOcAmt, deductionTodAmt, deductionIITPAmt, deductionRdType, deductionOcType, deductionTodType, deductionIITPType, otherDeductionRdIITPDebitAcc, otherDeductionOcDebitAcc, otherDeductionTodDebitAcc) {
