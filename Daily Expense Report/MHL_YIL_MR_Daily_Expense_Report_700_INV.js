 ...
 * Script Name: MHL MR Daily Run Expense report INV 7000
 * File Name: MHL_YIL_MR_Daily_Expense_Report_700_INV.js
 * Created On: 20/03/2023
 * Modified On:
 * Created By: Avinash Lahane(Yantra Inc.)
 * Modified By:
 * Description: Daily Run Expense report INV 7000
 *********************************************************** */
        ...
        function getInputData() {
            ...
            try {
                ...
                var fileSearchObj = search.load({
                    id: 'customsearch_mhl_gl_subi_date_report_3'
                });
        ...
        function map(context) {
            try {
				...
				var transactionSearchObj = search.create({
				   type: "transaction",
					title: 'Gl_Extraction_Report_INV_' +subsidiaryTxt+"_"+dateString+"_"+string,
				   filters:
				   [
				...
				{
					var File_Name = 'Gl_Extraction_Report_INV_' + subsidiaryTxt + '_' + dateString +  '.csv';
