 ...
 * Script Name: MHL MR Daily Run Expense report
 * File Name: MHL_MR_Daily_expense_report.js
 * Created On: 03/03/2022
 * Modified On:
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Generate GL Data Posting Date wise
 *********************************************************** */
        ...
        function getInputData() {
            ...
            try {
                ...
                var fileSearchObj = search.load({
                    id: 'customsearch_mhl_gl_subi_date_report'
                });
        ...
        function map(context) {
            try {
				...
				var transactionSearchObj = search.create({
				   type: "transaction",
					title: 'Gl_Extraction_Report__' +subsidiaryTxt+"__"+dateString+"_"+string,
				   filters:
				   [
					  ["trandate","on",postiong_Date], 
					  "AND", 
					  ["posting","is","T"],
					  "AND", 
				...
				{
					var File_Name = 'Gl_Extraction_Report__' + subsidiaryTxt + '__' + dateString +  '.csv';
