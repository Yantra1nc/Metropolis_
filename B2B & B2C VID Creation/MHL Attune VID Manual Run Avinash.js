 ...
 * Script Name: MHL Attune VID Manual Run Avinash
 * File Name: MHL Attune VID Manual Run Avinash.js
 * Created On: 
 * Modified On: 06/04/2022
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Attune VID manula run
 *********************************************************** */
...
define(['N/file', 'N/format', 'N/record', 'N/search', 'N/runtime', './mhllib', './datellib'],
    ...
    function(file, format, record, search, runtime, mhllib, datellib) {
        ...
        function getInputData() {
            try {
                return search.load({
                    id: 'customsearch_attun_vid_manual_run_avinas'
                });
            } catch (e) {
        ...
        function createVIDForJson(JSONfromRnI, fileName, fileId) {
            try {
                ...
                if (visitDate) {
                    ...
                    if (!invoiceRecId) {
                        ...
                        if (registeredOrg) {
                            ...
                            if (customerDetails) {
                                ...
                                if (customerSegment && customerSegment != '' && customerSegment != ' ') {
                                    ...
                                    if (consolidatedItem) {
                                        ...
                                        //Code added to avoid Payment transaction for overseas on 01022022
                                        ...
                                        var o_subObj = record.load({
                                            type: record.Type.SUBSIDIARY,
                                            id: i_subsidiaryId,
                                            isDynamic: true,
                                        });

                                        // country from subsidiary record                                       
                                        var i_subsidiary = o_subObj.getValue({
                                            fieldId: 'country'
                                        });

                                        var s_subsidiary = o_subObj.getText({
                                            fieldId: 'country'
                                        });
                                       // log.audit("i_subsidiary: ",i_subsidiary+'#s_subsidiary: '+s_subsidiary);
                                            ...
                                            if (_logValidation(testArray)) {
                                                ...
                                                for (var testLine in testObject.testCode) {
                                                    ...
                                                    if (_nullValidation(i_item_internal_id)) {
                                                        ...
                                                        createRnIRecord('Item Not found for Test Code ' + testObject.testCode[testLine], fileName, fileId,'',"Item Not Found");
                                                        return '';
                                                    }
                                        ...
                                        for (var pay in paymentInfo) {
                                            ...
                                            if (payMode != '0' && payMode != '1') {
                                                ...
                                                {
                                                    if(i_subsidiary == 'IN' || s_subsidiary == 'India')
                                                    {
                                                        log.audit('calling Create Payment function');
                                                    ...
                                                    {
                                                        log.audit('No Payment record creation.');
                                                    }
                                        ...
                                        createRnIRecord('Revenue Item not found for segment ' + customerSegment + ' For VID ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId,"","Revenue Item not found for segment");
                                    }
                                } else {
                                    ...
                                    createRnIRecord('Test Missing in VID JSON ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId,"","Test Missing in VID JSON");
                                    return '';
                                }
                            } else {
                            ...
                            createRnIRecord('Registered Location details not found ' + JSONfromRnI.VisitInfo.LocationID + ' For VID ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId,"","Registered Location details not found");
                        }
                    } else {
                ...
                createRnIRecord('Error Occured for For VID ' + JSONfromRnI.VisitInfo.VisitNumber + ' details ' + JSON.stringify(inve), fileName,fileId,"Script Errors "+inve.name);
            }
        }
            ...
            try {
              ...
              var mapKeysNotProcessed = 0;
                ...
                log.audit({
                    ...
                    details: 'Total number of map keys processed successfully: ' + mapKeysProcessed+" | Not Processed "+mapKeysNotProcessed
                });
            } catch (e) {
                log.debug({
