 ...
 * Script Name: MHL YIL MR Send Rni Test add Json
 * File Name: MHL Read Rni Test Add json.js
 * Created On: 22/04/2022
 * Modified On:
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Send Rni Test add Json
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib, callrestdata) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_move_rni_test_add_file'
	                });
