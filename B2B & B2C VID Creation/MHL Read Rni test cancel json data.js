 ...
 * Script Name: MHL YIL MR Send Rni Test Cancel Json
 * File Name: MHL Read Rni test cancel json data.js
 * Created On: 22/04/2022
 * Modified On:
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Send Rni Test Cancel Json
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib, callrestdata) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_move_rni_test_cancel_file'
	                });
