 ...
 * Script Name: MHL YIL MR Send Attune VID JSON
 * File Name: MHL read Attune VID json data.js
 * Created On: 22/04/2022
 * Modified On:
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Send Attune VID JSON
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib, callrestdata) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_move_attune_vid_file_sandbx'
	                });
