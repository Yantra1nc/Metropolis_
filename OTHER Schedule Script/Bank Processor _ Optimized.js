 ...
 * 1.00       31 Jul 2020     ONKARS4      Bank Processor _ Optimized.js
 *
 */
...
function scheduled(type) {
    try {
        ...
        var searchId = context.getSetting('SCRIPT', 'custscript_mhl_saved_serch_id_nov');
        ...
        if (_logValidation(jsonArray)) {
            ...
            //var sch_script = nlapiScheduleScript('customscript_bank_processed_nov', 'customdeploy_bank_deposit_json_processor', null);
            //End
            // Code added by Kailas on 30th nov 2020
            //if (deplymentId != 'customdeploy5')

            var sch_script = nlapiScheduleScript('customscript_bank_processed_nov', deplymentId, null);
            //End
...
nlapiLogExecution('AUDIT', 'invoiceSearch', invoiceSearch.length); */
                        ...
                        for (var v in vidArray) {
                            ...
                            for (var d in invoiceSearch) {
                                ...
                                if (vidArray[v] == invoiceSearch[d].getValue(allCols[3]) && invoiceSearch[d].getValue(allCols[4]) == 'CustInvc') {
                                   ...
                                   // nlapiLogExecution('AUDIT', 'Before FindPosition customerId', 'customerId ==> ' + customerId + 'customerViseAmt ==> ' + customerViseAmt);
                    ...
                    if (depositRecord.getLineItemCount('other') > 0) {
                        ...
                        if (depositId) {
							...
							//nlapiLogExecution("audit","VIDRefParentRecId",VIDRefParentRecId)
            ...
            nlapiLogExecution('DEBUG', 'Location code not found');
