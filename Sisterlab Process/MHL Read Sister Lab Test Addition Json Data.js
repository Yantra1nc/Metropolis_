 ...
 * Script Name: MHL YIL MR Send Sister Lab Test Add Json
 * File Name: MHL Read Sister Lab Test Addition Json Data.js
 * Created On: 22/04/2022
 * Modified On:
 * Created By:Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Send Sister Lab Test Add Json
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib, callrestdata) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_move_sister_lab_test_a_file'
	                });
