/**
 * Script Name:  MHL_YIL_MAP_attune_VID_Test_Addition.js
 * @NApiVersion 2.x
 ...
 * Script Name: MHL YIL MAP B2B Sister VID Test Addition
 * File Name: MHL_YIL_MAP_B2B_Sister_Lab_VID_Test_Addition.js
 * Created On: 29/05/2022
 * Modified On:
 * Created By: Avinash Lahane(Yantra Inc.)
 * Modified By:
 * Description: B2B Sister VID Test Addition
 *********************************************************** */
...
define(['N/file', 'N/format', 'N/record', 'N/search','N/runtime','./mhllib'],
	...
	function map(context) {
		try {
			...
			createRnIRecord(ex,jsonFile.name,"Error in MAP Function");	
			jsonFile.folder='168935';
			jsonFile.save();
		}
	}
				...
				if(!locationCenterDetails.orgInternalId)
				{
					...
					var customerDetails=searchCustomer(JSONfromRnI.VisitInfo.ClientCode,registeredOrg,custSubsidiary,JSONfromRnI.OrgID);
						...
						}else
						{
							...
							createRnIRecord('Test Missing in VID JSON '+JSONfromRnI.VisitInfo.VisitNumber,fileName,"Test Missing In JSON");
							return '-168935';
						}
						...
						{  ////B2B nd 
										...
										for (var te in testArray) {
											...
											if (testArray[te].ProcessingLocationCode) {
												...
												createRnIRecord("Processing Location Code not found for " + JSONfromRnI.VisitInfo.VisitNumber, fileName,"Processing Location Code Not Found");
												//return '-356151';
											}
