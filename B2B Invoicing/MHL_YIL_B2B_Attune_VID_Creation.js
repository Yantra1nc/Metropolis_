 ...
 * Script Name: MHL B2B VID Creation | Attune
 * File Name: MHL_YIL_B2B_Attune_VID_Creation.js
 * Created On:
 * Modified On: 13/12/2022
 * Created By: Avinash Lahane(Yantra Inc.)
 * Modified By:
 * Description: Attune B2B VID Creation
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_mhl_b2b_attune_vid_creation'
	                });
	            ...
	            try {
	                ...
	                if (visitDate) {
	                    ...
	                    if (f_dupVID) {
	                        ...
	                        if (orgInternalId) {
	                            ...
	                            if (customerDetails) {
	                                ...
	                                if (customerPaymentType != 1) {
										...
										o_vidObj.setValue({
	                                        fieldId: 'custrecord_time_details_string',
	                                    ...
	                                    if (JSONfromRnI.Billinfo.CopayClientAmount) {
	                                        o_vidObj.setValue({
	                        ...
	                        createRnIRecord('Duplicate VID Number found ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId,'',"Attune duplicate VIDs");
	                        return '-5544';
	                    }
	                } else {
	                    createRnIRecord('Visit Date is not available in JSON for ' + JSONfromRnI.VisitInfo.VisitNumber, fileName, fileId,'',"Visit Date issue");
	                    return '';
	                }
	                ...
	                createRnIRecord('Error Occured for For VID ' + JSONfromRnI.VisitInfo.VisitNumber + ' details ' + JSON.stringify(inve), fileName,'','',"Attune Script Error");
	                return '';
	            }
	        }
