 ...
 * Script Name: MHL YIL MAP PDF Transfer
 * File Name: MHL YIL MAP Invoice PDF file Transfer.js
 * Created On: 18/07/2022
 * Modified On:
 * Created By: Avinash Lahane(Yantra Inc.)
 * Modified By:
 * Description: Invoice PDF file Transfer
 *********************************************************** */
...
function(record, search, runtime, email,format,file,task,sftp) {
	...
	function folder_search(){
		...
		var folderSearchObj = search.create({
			   ...
			   "AND",
			   ["file.created","onorafter","yesterday"]
			   //"AND", 
