 ...
 * Script Name: MHL YIL GL Data Backup File Transfer
 * File Name: MHL YIL MR Gl Data Backup File Transfer.js
 * Created On: 20/03/2023
 * Modified On:
 * Created By: Avinash Lahane(Yantra Inc.)
 * Modified By:
 * Description: GL Data Backup File Transfer
 *********************************************************** */
		  ...
		  {				
			...
			if(file_internalId && Folder_name){
				...
				var upload_file = o_connectionOBJ.upload({
					directory: '/DATA BACKUP/FY2023-24/'+Folder_name,
