 ...
 * Script Name: MHL YIL MR Send Rni Bank Deposit JSON
 * File Name: MHL YIL MR Send Bank Deposit json.js
 * Created On: 25/04/2022
 * Modified On:
 * Created By: Ganesh Sapakale(Yantra Inc.)
 * Modified By:
 * Description: Send Rni Bank Deposit JSON
 *********************************************************** */
	    ...
	    function(file, format, record, search, runtime, mhllib, datellib, callrestdata) {
	        ...
	        function getInputData() {
	            ...
	            try {
	                ...
	                return search.load({
	                    id: 'customsearch_move_bank_deposite_file_'
	                });
